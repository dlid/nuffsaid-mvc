 ...
 */
class CFormContact2 extends \Mos\HTMLForm\CForm {
  ...
  protected function DoSubmit() {
    ...
    echo "<p style='color:#fff'><i>DoSubmit(): Form was submitted. Do stuff (save to database) and return true (success) or false (failed processing form)</i></p>";
    return true;
  }
