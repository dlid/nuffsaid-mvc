   ...
   /**
    ...
    public function __construct()
    {
        ...
        $this->setShared('session', function () {
            ...
            $session->configure(ANAX_APP_PATH . 'config/session.php', true);
            $session->name();
            $session->start();
            return $session;
        });
        ...
        $this->setShared('theme', function () {
            ...
            $themeEngine->configure(ANAX_APP_PATH . 'config/theme.php', true);
        ...
        $this->setShared('navbar', function () {
            ...
            $navbar->configure(ANAX_APP_PATH . 'config/navbar.php', true);
            $navbar->setDI($this);
            return $navbar;
        });
        ...
        $this->setShared('textFilter', function () {
            ...
            $filter->configure(ANAX_APP_PATH . 'config/text_filter.php', true);
            return $filter;
        });
    }
}
